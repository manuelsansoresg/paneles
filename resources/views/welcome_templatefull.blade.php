    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="about.html" class="nav-item nav-link">COMPUTACIÓN</a>
                <a href="service.html" class="nav-item nav-link">PANELES</a>
                <a href="project.html" class="nav-item nav-link">CÁMARAS</a>
               {{--  <div class="nav-item dropdown">
                ...
                <a href="contact.html" class="nav-item nav-link">CLIENTES</a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
